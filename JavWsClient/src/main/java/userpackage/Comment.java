...
public class Comment  implements java.io.Serializable {
    ...
    private userpackage.Place place;
     ...
     * @return place
     */
    public userpackage.Place getPlace() {
        return place;
    }
     ...
     * @param place
     */
    public void setPlace(userpackage.Place place) {
        this.place = place;
    }
     ...
     * @param user
     */
    public void setUser(userpackage.User user) {
        this.user = user;
    }
