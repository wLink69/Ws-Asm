...
public class MyServiceServiceLocator extends org.apache.axis.client.Service implements userpackage.MyServiceService {
    ...
    public userpackage.MyService getMyServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            userpackage.MyServicePortBindingStub _stub = new userpackage.MyServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (userpackage.MyService.class.isAssignableFrom(serviceEndpointInterface)) {
                userpackage.MyServicePortBindingStub _stub = new userpackage.MyServicePortBindingStub(new java.net.URL(MyServicePort_address), this);
                _stub.setPortName(getMyServicePortWSDDServiceName());
                return _stub;
            }
        }
